...
Sadly, this is an early draft of the webapp we used.  

The final version was beautiful ... all the input boxes were centered and square over the album cover images, and everything fit perfectly on an iPhone.

This version you have to drag around to get to all the inputs.

The final version got deleted on the free server due to inactivity :(
